...
export function WhiteContainer({ text, imgPath, imgAlt }) {
    return (
        <div className="bg-white rounded-lg shadow-lg p-5 md:overflow-hidden md:h-full md:w-full">
...
export function WhiteContainerDescriptive({ textTitle, textDescription, imgPath, imgAlt }) {
    return (
        <div className="bg-white p-6 space-y-3 rounded-lg shadow-lg md:h-full md:w-full">
...
export function PurpleContainer({ text, imgPath, imgAlt }) {
    return (
        <div className="flex flex-col md:flex-row items-center justify-center bg-purple-500 rounded-lg shadow-lg p-5 space-y-8 md:h-full md:w-full">
            <img className="flex-1/2 md:flex-1/3 w-[20rem] md:h-[90%] md:w-auto"src={imgPath} alt={imgAlt} />
